...
public class MondayHydratedItemDto
{
    ...
    public IEnumerable<MondayItemDto> SubItems { get; set; } = new List<MondayItemDto>();
    public IEnumerable<MondayUpdateDto> Updates { get; set; } = new List<MondayUpdateDto>();
}
